...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.title": {
    en: "Never miss another call.",
    es: "No pierdas ni una llamada.",
    fr: "Ne manquez plus aucun appel.",
    de: "Verpassen Sie keinen Anruf mehr.",
  },
  "hero.lead": {
    en: "Orvius answers your after-hours calls, books the job, and alerts you in seconds — so no lead ever dies on voicemail.",
    es: "Orvius contesta tus llamadas fuera de horario, agenda el trabajo y te avisa en segundos — para que ningún cliente se pierda en el buzón de voz.",
    fr: "Orvius répond à vos appels en dehors des heures d'ouverture, planifie l'intervention et vous alerte en quelques secondes — aucun prospect ne se perd dans la messagerie.",
    de: "Orvius nimmt Ihre Anrufe außerhalb der Geschäftszeiten entgegen, bucht den Auftrag und benachrichtigt Sie in Sekunden — kein Kunde geht mehr in der Mailbox verloren.",
  },
  "hero.cta": {
