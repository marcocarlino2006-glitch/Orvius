...
export const RECEPTIONIST_VOICES = [
  { id: "c894559e-d529-4d70-a6fb-3330ecf7ef6b", label: "Iris", description: "Warm, conversational · female" },
  { id: "db6b0ed5-d5d3-463d-ae85-518a07d3c2b4", label: "Skylar", description: "Bright, friendly · female" },
  { id: "55deba52-bc73-4481-ab69-9c8831c8a7c3", label: "Camille", description: "Calm, reassuring · female" },
  { id: "a0e99841-438c-4a64-b679-ae501e7d6091", label: "Greg", description: "Deep, steady · male" },
  { id: "5fc5c797-12c5-4f2b-ac9b-d4e53c08098f", label: "Wyatt", description: "Friendly, easygoing · male" },
  { id: "d46abd1d-2d02-43e8-819f-51fb652c1c61", label: "Grant", description: "Clear, professional · male" },
] as const;
