...
Orvius's defensibility should compound in this order:

| Layer | What compounds |
|-------|----------------|
| Configuration | Business policies, service area, hours, job types, escalation rules, and scripts. |
| Workflow data | Labeled conversations, outcomes, booking accuracy, handoffs, and follow-up results. |
| Integrations | Phone, calendar, FSM, dispatch, invoicing, and payments. |
| Reputation | Case studies, references, support quality, and category expertise. |
| Distribution | Partners, associations, agencies, consultants, and referrals. |
| Economic embedding | Payments, collections, and financial workflows. |
...
*Related: `docs/OPERATING-SCORECARD.md`, `docs/MULTI-BILLION-BATTLES.md`, `docs/WEDGE-MASTERY.md`*
