...
| H21 | Observability (Sentry) | FOUNDER_GATE |
| H22 | Public rate limits | CODE_DONE |
| H23 | Formation unset | FOUNDER_GATE |
| H24 | One mailbox collapse | FOUNDER_GATE |
| H25 | Support SLA vs staffing | FOUNDER_GATE |
...
1. Twilio + Vapi → live wedge 8/8  
2. Stripe keys + prices + webhook → first paid shop  
3. Resend key + from domain  
4. Counsel formation → `formationStateConfirmed`  
5. One named proof chapter  
6. Real outreach list (replace seeds)  
7. Support staffing or honest SLA rewrite  
8. Optional: Sentry DSN  
