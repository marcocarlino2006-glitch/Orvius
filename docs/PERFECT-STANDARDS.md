...
- **B6:** globals.css ~13.9k after Pass3 delete, strict unused purge, selector dedupe, night collapse, comment strip (was 26.9k → 16.3k → 13.9k). Target <8k still open. Multi-b stays 9/11 under MULTI_B_CI=1.
